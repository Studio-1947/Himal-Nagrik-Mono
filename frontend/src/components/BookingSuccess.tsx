...
export const BookingSuccess = ({ bookingData, onNewBooking }: BookingSuccessProps) => {
  ...
  const copyBookingId = async () => {
    ...
    try {
      ...
      toast({
        title: "Copy failed",
        description: "Could not copy the booking ID. Please copy it manually.",
        variant: "destructive",
      });
    }
  };
      ...
      <Card className="border-success/20 bg-success/5">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-primary/10 rounded-lg p-4">
            ...
            <p className="text-sm text-muted-foreground mt-1">Please pay the driver in cash.</p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="pt-6">
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>- Contact the driver for any questions: {bookingData.taxi.phone}.</li>
            </ul>
          </div>
        </CardContent>
      </Card>
