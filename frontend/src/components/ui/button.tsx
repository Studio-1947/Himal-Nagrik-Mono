...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-taxi text-primary-foreground hover:shadow-taxi hover:scale-105 active:scale-95",
        ...
        taxi: "bg-gradient-taxi text-primary-foreground hover:shadow-taxi hover:scale-105 active:scale-95 font-semibold",
        mountain: "bg-gradient-mountain text-secondary-foreground hover:shadow-soft hover:scale-105 active:scale-95",
