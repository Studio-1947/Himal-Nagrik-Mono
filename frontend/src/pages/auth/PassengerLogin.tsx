...
const passengerHighlights = [
  {
    ...
    description:
      "Check live seat availability before you leave your home base.",
  },
  {
    icon: Users,
    title: "Familiar co-travellers",
    description:
      "Ride with trusted community members you have travelled with before.",
  },
  {
    icon: HeartHandshake,
    title: "Save favourite routes",
    description:
      "Bookmark your frequent journeys for one-tap booking next time.",
  },
];
  ...
  return (
    ...
    >
      <div className="space-y-8">
        <LoginForm role="passenger" onSuccess={handleSuccess} />
        ...
        <div className="border-t border-white/10 pt-6">
          <p className="text-sm font-medium uppercase tracking-[0.35em] text-white/40">
            Why passengers love Himal Nagrik
          </p>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-emerald-400/30 bg-emerald-500/10 p-4 text-sm text-emerald-100">
          ...
          <Button
            variant="outline"
            className="border-emerald-300/40 bg-transparent text-emerald-100 hover:bg-emerald-500/10"
